...
window.BURKA_DATA = {
  ...
  /* ------------------------------------------------------------------ */
  preloader: { enabled: true, oncePerSession: false, darkMs: 450, animMs: 2100, fadeMs: 850 },
  ...
  /*   На сайте над ними висит жёлтая плашка-предупреждение.             */
  /*   Соберите живые отзывы (WhatsApp, Telegram, Instagram), впишите    */
  /*   их сюда и поставьте reviewsAreDemo: false — плашка исчезнет.      */
  /* ------------------------------------------------------------------ */
  reviewsAreDemo: true,
